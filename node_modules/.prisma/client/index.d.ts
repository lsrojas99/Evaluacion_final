  ...
  */
  ...
  export type UserGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        P extends 'pets' ? Array < PetGetPayload<S['include'][P]>>  :
        P extends '_count' ? UserCountOutputTypeGetPayload<S['include'][P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'pets' ? Array < PetGetPayload<S['select'][P]>>  :
  ...
  export class Prisma__UserClient<T> implements PrismaPromise<T> {
    ...
    pets<T extends PetFindManyArgs = {}>(args?: Subset<T, PetFindManyArgs>): CheckSelect<T, PrismaPromise<Array<Pet>>, PrismaPromise<Array<PetGetPayload<T>>>>;
  ...
  type GetPetGroupByPayload<T extends PetGroupByArgs> = PrismaPromise<
    Array<
  ...
  export type PetGetPayload<
    S extends boolean | null | undefined | PetArgs,
    U = keyof S
      > = S extends true
        ? Pet
    : S extends undefined
    ? never
    : S extends PetArgs | PetFindManyArgs
    ?'include' extends U
    ? Pet  & {
    [P in TrueKeys<S['include']>]:
    ...
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'user' ? UserGetPayload<S['select'][P]> | null :  P extends keyof Pet ? Pet[P] : never
  } 
    : Pet
  : Pet


  type PetCountArgs = Merge<
    Omit<PetFindManyArgs, 'select' | 'include'> & {
      select?: PetCountAggregateInputType | true
    }
  >

  export interface PetDelegate<GlobalRejectSettings> {
    /**
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Pet'> extends True ? CheckSelect<T, Prisma__PetClient<Pet>, Prisma__PetClient<PetGetPayload<T>>> : CheckSelect<T, Prisma__PetClient<Pet | null >, Prisma__PetClient<PetGetPayload<T> | null >>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Pet'> extends True ? CheckSelect<T, Prisma__PetClient<Pet>, Prisma__PetClient<PetGetPayload<T>>> : CheckSelect<T, Prisma__PetClient<Pet | null >, Prisma__PetClient<PetGetPayload<T> | null >>
    ...
    **/
    ...
    ): CheckSelect<T, PrismaPromise<Array<Pet>>, PrismaPromise<Array<PetGetPayload<T>>>>
    ...
    **/
    ...
    ): CheckSelect<T, Prisma__PetClient<Pet>, Prisma__PetClient<PetGetPayload<T>>>
     ...
     *     
    **/
    createMany<T extends PetCreateManyArgs>(
      args?: SelectSubset<T, PetCreateManyArgs>
    ): PrismaPromise<BatchPayload>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends PetAggregateArgs>(args: Subset<T, PetAggregateArgs>): PrismaPromise<GetPetAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, PetGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPetGroupByPayload<T> : PrismaPromise<InputErrors>
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__PetClient<T> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
  ...
  export type PetFindUniqueArgs = {
    ...
    **/
    ...
    /**
     * Throw an Error if a Pet can't be found
     * 
    **/
    rejectOnNotFound?: RejectOnNotFound
    /**
  ...
  export type PetWhereUniqueInput = {
    id?: number
    name_userId?: PetNameUserIdCompoundUniqueInput
  }
  ...
  export type UserUncheckedUpdateInput = {
    ...
    email?: StringFieldUpdateOperationsInput | string
    password?: StringFieldUpdateOperationsInput | string
    pets?: PetUncheckedUpdateManyWithoutUserInput
  }
  ...
  export type PetNameUserIdCompoundUniqueInput = {
    name: string
    userId: number
  }
  ...
  export type PetCreateNestedManyWithoutUserInput = {
    create?: XOR<Enumerable<PetCreateWithoutUserInput>, Enumerable<PetUncheckedCreateWithoutUserInput>>
    connectOrCreate?: Enumerable<PetCreateOrConnectWithoutUserInput>
  ...
  export type PetUpdateManyWithoutUserInput = {
    create?: XOR<Enumerable<PetCreateWithoutUserInput>, Enumerable<PetUncheckedCreateWithoutUserInput>>
    connectOrCreate?: Enumerable<PetCreateOrConnectWithoutUserInput>
    upsert?: Enumerable<PetUpsertWithWhereUniqueWithoutUserInput>
    createMany?: PetCreateManyUserInputEnvelope
    set?: Enumerable<PetWhereUniqueInput>
    disconnect?: Enumerable<PetWhereUniqueInput>
    delete?: Enumerable<PetWhereUniqueInput>
    connect?: Enumerable<PetWhereUniqueInput>
    update?: Enumerable<PetUpdateWithWhereUniqueWithoutUserInput>
    updateMany?: Enumerable<PetUpdateManyWithWhereWithoutUserInput>
  ...
  export type UserUpdateOneWithoutPetsInput = {
    create?: XOR<UserCreateWithoutPetsInput, UserUncheckedCreateWithoutPetsInput>
    connectOrCreate?: UserCreateOrConnectWithoutPetsInput
  ...
  export type PetCreateManyUserInputEnvelope = {
    data: Enumerable<PetCreateManyUserInput>
    skipDuplicates?: boolean
  }
